...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <Page>
      <iframe src="https://quickswap.exchange/#/add/0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174/0xF4B0903774532AEe5ee567C02aaB681a81539e92" title="Add Liquidity to STAR" height='700px' width="100%"/>
    </Page>
  )
}
